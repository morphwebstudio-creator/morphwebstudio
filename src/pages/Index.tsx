          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center" style={{ animationDelay: "0.3s", animationFillMode: "forwards", opacity: 0, animation: "fade-in 0.6s ease-out 0.3s forwards" }}>
              ...
              <a
                ...
                className="inline-flex h-12 items-center gap-2 rounded-md border border-primary-foreground/20 px-8 text-base font-medium text-primary-foreground transition-colors hover:border-accent hover:text-accent"
              >
