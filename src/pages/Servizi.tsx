      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="animate-slide-up">
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] text-foreground">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="animate-slide-up">
            ...
            <p className="mt-4 text-sm md:text-base font-semibold leading-relaxed text-foreground">
